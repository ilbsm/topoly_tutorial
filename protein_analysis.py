...
print(alexander(curve, closure='two_points', translate=True))

# analysis of the whole chain using the Alexander polynomial with closed by rays, 100 times
print(alexander(curve, closure='rays', tries=100, translate=True))

# analysis of the subchains and present it as a matrix
matrix = alexander(curve, matrix=True, closure='two_points', translate=True)
